...
@section('title', 'News & Articles Filter Result')

@section('metaTitle')
  <meta name="title" content="Article List Sriboga Raturaya">
@endsection
        ...
        <div class="container news-header">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <h1 class="section-1-subtitle">Get to know PT Sriboga Raturaya better! Discover and read the latest news and insights from us here.</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="my-2 col-md-3">
                        ...
                        <div class="dropdown" style="max-height: 60px">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                @foreach($category as $cat)
                                    <button class="dropdown-item" type="submit" name="category" value="{{ $cat->name }}">{{($cat->name)}}</button>
                                @endforeach
                            </div>
                        </div>
                    </div>
              ...
              <div class="col-md-4">
                <div class="ui-state-default latest-news card card-widget widget-user">
                  <div class="latest-news widget-user-header">
                    <img class="card-img-top" src="{{asset($items->image_url)}}" alt="Card image cap">
                  </div>
