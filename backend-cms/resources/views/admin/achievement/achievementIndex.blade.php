                ...
                <div class="card card-default">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a type="button" href="{{url('achievement/create')}}" class="banner btn-block btn-lg">Add</a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="ui-state-default banner card card-widget widget-user">
                                        ...
                                        <div class="banner card-header">
                                            ...
                                            <h2>{{$items->reward}}</h2>
                                            <h3>{{$items->created_time->format('d F Y h:m')}}</h3>
                                        </div>
...
<script>
    ...
    $('#confirmModal').on('shown.bs.modal', function (e) {
        ...
        $('#deleteForm').attr('action', '/achievement/delete/' + btn.data('value'));
    });
</script>
@endsection
