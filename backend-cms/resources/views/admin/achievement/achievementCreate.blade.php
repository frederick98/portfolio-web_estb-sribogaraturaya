        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="banner breadcrumb float-sm-left">
                  ...
                  <li class="banner breadcrumb-item active">Add Achievements</li>
                </ol>
          </div>
        </div>
      </div>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="card card-default">
          <div class="banner-create card-header">
            <h3 class="card-title offset-4">Add Achievements</h3>
              ...
              <div class="row">
                ...
                <div class="banner-input-h col-md-6" style="display: block">
                  <div class="banner-input form-group">
                    ...
                    <input type="text" name="organization" class="form-control" id="organization" placeholder="type organization..." autocomplete="off" value="{{old('organization')}}" required maxlength="200" >
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Reward<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="reward" class="form-control" id="reward" placeholder="type reward..." autocomplete="off" value="{{old('reward')}}" required maxlength="100" >
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Alt Image<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="alt_text" class="form-control" id="alt_text" placeholder="type alt..." autocomplete="off" value="{{old('reward')}}" required maxlength="60" >
                  </div>
                  <div class="banner-input form-group">
