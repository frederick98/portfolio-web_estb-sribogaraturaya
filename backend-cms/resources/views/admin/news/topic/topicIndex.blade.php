...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="news breadcrumb float-sm-left">
                        <li class="news breadcrumb-item"><a href="{{url('/news-insight/topic')}}">Master Data Topic</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="tableList" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                <thead>
                                    <tr>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column ascending">Topic Name</th>
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                <!-- <div class="row justify-content-end">
                                                    <div class="col-md-2"> -->
                                                        <!-- <a type="button" href="{{url('/news-insight/category/edit', [$items->id])}}" class="btn btn-primary">Update</a> -->
                                                        ...
                                                        <!-- <a type="button" href="#" data-id="{{$items->id}}" data-name="{{$items->name}}" class="btn btn-primary editBtn">Update</a> -->
                                                    <!-- </div>
                                                    <div class="col-md-2"> -->
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="createForm" action="/news-insight/topic/create">
                    {{csrf_field()}}
                    <div class="modal-header" style="color: #307430;">
                        <h5 class="modal-title modal-default" id="exampleModalLabel">Create Topic</h5>
    ...
    <!-- <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="createForm" action="{{url('/news-insight/topic/edit')}}">
                    {{csrf_field()}}
                    @method('PUT')
                    <div class="modal-header" style="color: #307430;">
                        <h5 class="modal-title modal-default" id="exampleModalLabel">Update Topic</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <div class="modal" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="editForm" action="{{url('/news-insight/topic/edit')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @method('PUT')
                    <div class="modal-header" style="color: #307430;">
                        <h5 class="modal-title modal-default" id="exampleModalLabel">Update Topic</h5>
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="post" id="deleteForm" action="/news-insight/topic/delete">
                    {{csrf_field()}}
                    {{method_field("DELETE")}}
                    <div class="modal-header" style="background-color: #dc3545; color: #ffffff;">
                        <h5 class="modal-title modal-danger" id="exampleModalLabel">Delete Topic</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
<script>
    ...
    $('#confirmModal').on('shown.bs.modal', function (e) {
        ...
        $('#deleteForm').attr('action', '/news-insight/topic/delete/' + btn.data('value'));
    });
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editBtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "/news-insight/topic/edit/" + id,
