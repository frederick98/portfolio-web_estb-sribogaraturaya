                ...
                <div class="card card-default">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a type="button" href="{{url('business/create')}}" class="banner btn-block btn-lg">Add</a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="ui-state-default banner card card-widget widget-user">
                                        ...
                                        <div class="widget-user-header"
                                            style="background-image: url('{{$items->image_url}}'); background-size: 100%; ">
                                        </div>
                                        ...
                                        <div class="card__overlay">
                                            <div class="overlay__text">
                                                ...
                                                <a type="button" href="{{url('business/edit', [$items->id])}}" class="btn btn-outline-light">Update</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $('#confirmModal').on('shown.bs.modal', function (e) {
        ...
        $('#deleteForm').attr('action', '/business/delete/' + btn.data('value'));
    });
</script>
@endsection
