        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="banner breadcrumb float-sm-left">
                  <li class="banner breadcrumb-item"><a href="{{url('business')}}">Business</a></li>
                  <li class="banner breadcrumb-item active">Edit Business</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="card card-default">
          <div class="banner-create card-header">
            <h3 class="card-title offset-4">Edit Business</h3>
          </div>
          <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="banner-input-h col-md-6" style="display: block">
                  ...
                  <div class="banner-input form-group">
                    ...
                    <input type="text" name="caption" class="form-control" id="caption" placeholder="type caption..." autocomplete="off" value="{{$first->caption}}" required>
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Alt Image<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="alt_text" class="form-control" id="alt_text" placeholder="type alt..." autocomplete="off" value="{{$first->alt_text}}" required>
                  </div>
                  <div class="banner-input form-group">
