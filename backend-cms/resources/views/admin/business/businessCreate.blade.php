        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="banner breadcrumb float-sm-left">
                  ...
                  <li class="banner breadcrumb-item active">Add Business</li>
                </ol>
          </div>
        </div>
      </div>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="card card-default">
          <div class="banner-create card-header">
            <h3 class="card-title offset-4">Add Business</h3>
              ...
              <div class="row">
                ...
                <div class="banner-input-h col-md-6" style="display: block">
                  ...
                  <div class="banner-input form-group">
                    ...
                    <input type="text" name="caption" class="form-control" id="caption" placeholder="type caption..." autocomplete="off" value="{{old('caption')}}" required>
                  </div>
                  <div class="banner-input form-group">
