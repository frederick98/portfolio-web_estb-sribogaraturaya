        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="banner breadcrumb float-sm-left">
                  <li class="banner breadcrumb-item"><a href="{{url('business')}}">Our Stories</a></li>
                  <li class="banner breadcrumb-item active">Edit Stories</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="card card-default">
          <div class="banner-create card-header">
            <h3 class="card-title offset-4">Edit Stories</h3>
          </div>
          <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="banner-input-h col-md-6" style="display: block">
                  <div class="banner-input form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="type title..." autocomplete="off" value="{{$first->name}}" required>
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Time<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="year" class="form-control" id="year" placeholder="select year..." autocomplete="off" value="{{$first->year}}" required>
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Caption<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="caption" class="form-control" id="caption" maxlength="150" placeholder="type caption..." autocomplete="off" value="{{$first->caption}}" required>
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Alt Image<span style="color:#d9534f">(*)</span></label>
                    <input type="text" name="alt_text" class="form-control" id="alt_text" maxlength="60" placeholder="type alt..." autocomplete="off" value="{{$first->alt_text}}" required>
                  </div>
                  <div class="banner-input form-group">
