        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <ol class="banner breadcrumb float-sm-left">
                  ...
                  <li class="banner breadcrumb-item active">Edit Banner</li>
                </ol>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                ...
                <div class="banner-input-h col-md-6" style="display: block">
                  ...
                  <div class="banner-input form-group">
                    ...
                    <input type="text" name="name" maxlength="100" class="form-control" id="name" placeholder="type title..." autocomplete="off" value="{{$first->name}}" required>
                  </div>
                  <div class="banner-input form-group">
                    <label for="selecttime">Redirect URL <span style="color:#d9534f">(*)</span></label>
                    <input type="url" name="url" maxlength="100" class="form-control" id="url" placeholder="type redirect url..." autocomplete="off" value="{{$first->url}}" required>
                  </div>
                  <div class="banner-input form-group">
