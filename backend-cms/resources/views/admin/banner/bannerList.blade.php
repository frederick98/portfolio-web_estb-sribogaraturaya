                ...
                <div class="card card-default">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a type="button" href="{{url('banner/create')}}" class="banner btn-block btn-lg">Add</a>
                            </div>
                        </div>
                                    ...
                                    <div class="ui-state-default banner card card-widget widget-user">
                                        ...
                                        <div class="card__overlay">
                                            <div class="overlay__text">
                                                ...
                                                <a type="button" href="{{url('banner/edit', [$items->id])}}" class="btn btn-outline-light">Update</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $('#confirmModal').on('shown.bs.modal', function (e) {
        ...
        $('#deleteForm').attr('action', '/banner/delete/' + btn.data('value'));
    });
</script>
@endsection
